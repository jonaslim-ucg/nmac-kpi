...
4. In Supabase **SQL Editor**, run in order:
   ...
   - For account-synced Settings (hide legacy nav, sample data, chart cache reset), run [`supabase/user-dashboard-preferences.sql`](supabase/user-dashboard-preferences.sql) once.
