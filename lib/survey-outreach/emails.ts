...
function buildHtmlBody(input: {
  ...
  return [
    ...
    '<p style="margin:0;font-size:14px;line-height:1.6;color:#071733;">Call <a href="tel:+14412930751" style="color:#174a63;text-decoration:underline;">(441) 293-0751</a> or WhatsApp <a href="https://wa.me/14419020751" style="color:#174a63;text-decoration:underline;">+1 (441) 902-0751</a>.</p>',
    "</td>",
    "</tr>",
    "</table>",
...
function buildContent(input: {
  ...
  const textBody = [
    ...
    RAFFLE_COPY,
    "",
    "Need help opening the survey? Call (441) 293-0751 or WhatsApp +1 (441) 902-0751.",
    "",
